{ pkgs, ... }:
{
  ...
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
      ...
      $fileManager = thunar
      $menu = bemenu-run -i
      $swaylock = swaylock --clock --indicator 
      ...
      bindel = ,XF86MonBrightnessUp, exec, brightnessctl set 5%- -n
      bindel = ,XF86MonBrightnessDown, exec, brightnessctl set 5%+ -n
  ...
  programs.fish.shellInit = ''
    set TTY1 (tty)
    [ "$TTY1" = "/dev/tty1" ] && 
          set -g XDG_SESSION_TYPE "wayland" && exec Hyprland
  '';
}
